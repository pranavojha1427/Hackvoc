    ...
    <div ref={ref} className="min-h-screen bg-[#050B14] text-white overflow-hidden selection:bg-[#00e5ff] selection:text-black font-sans">
      ...
      <div className="fixed inset-0 z-0 flex items-center justify-center pointer-events-none opacity-40 md:opacity-60">
          <div className="relative w-64 h-64 flex items-center justify-center mt-12">
              ...
              <motion.div 
                  ...
                  className="absolute w-[250px] h-[250px] md:w-[320px] md:h-[320px] border border-[#00e5ff]/30 rounded-full border-dashed"
              />
              <motion.div 
                  animate={{ rotate: -360, scale: [1, 1.02, 1] }}
                  transition={{ rotate: { duration: 35, repeat: Infinity, ease: "linear" }, scale: { duration: 5, repeat: Infinity, ease: "easeInOut" } }}
                  className="absolute w-[300px] h-[300px] md:w-[450px] md:h-[450px] border border-[#00e5ff]/10 rounded-full"
              />

              <motion.div animate={{ y: [-15, 15, -15] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}>
                <BrainCircuit className="w-16 h-16 md:w-[100px] md:h-[100px] text-[#00e5ff] drop-shadow-[0_0_30px_rgba(0,229,255,0.8)]" strokeWidth={1} />
              </motion.div>
          </div>
      </div>
      ...
      <div className="w-full flex justify-center items-center py-12 relative z-50">
        <motion.div 
          ...
          className="flex items-center gap-2 md:gap-4 font-extrabold text-5xl md:text-8xl tracking-tighter"
        >
          <Sparkles className="text-[#00e5ff] w-12 h-12 md:w-24 md:h-24 drop-shadow-[0_0_30px_rgba(0,229,255,0.8)]" />
      ...
      {/* Action Plans */}
      <section id="plans" className="relative z-10 py-16 px-4 md:px-8 max-w-5xl mx-auto mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div 
             ...
             className="relative p-6 md:p-8 rounded-3xl bg-[#0a1120] border border-gray-800 hover:border-blue-500 transition-all overflow-hidden"
          >
          ...
          <motion.div 
             whileHover={{ y: -10, scale: 1.02 }}
             className="relative p-6 md:p-8 rounded-3xl bg-[#0a1525] border border-[#00e5ff]/30 hover:border-[#00e5ff] shadow-[0_0_30px_rgba(0,229,255,0.1)] hover:shadow-[0_0_40px_rgba(0,229,255,0.2)] transition-all overflow-hidden"
          >
